...
# Хедэр -> `header.header>.container>img.icon+nav.nav>ul.nav__list>li.nav__item*5>a.nav__link` 
![Image alt](header.png)
# Форма ->  `section.section.section--bg>.container>(ul.info>(li.info__item*2>p.info__title+p.info__text)+li.info__item>p.info__title+p.info__text*3)+form.form>p.form__title+label*5+input.form__item*5+button.form__button`
![Image alt](form.png)
